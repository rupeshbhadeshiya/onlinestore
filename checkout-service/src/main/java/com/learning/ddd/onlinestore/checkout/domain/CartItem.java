...
public class CartItem implements Serializable {
	...
	private static final long serialVersionUID = -7532051472380494422L;
...
//	private Order order;
	...
	public CartItem(String category, String subCategory, String name, int quantity, double price) {
	...
	public CartItem(int itemId, String category, String subCategory, String name, int quantity, double price) {
		this.itemId = itemId;
		this.category = category;
		this.subCategory = subCategory;
		this.name = name;
...
//	}
	...
	public String toString() {
		return "CartItem [itemId=" + itemId + ", category=" + category + ", subCategory=" + subCategory 
