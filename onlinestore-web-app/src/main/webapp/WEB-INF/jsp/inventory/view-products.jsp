<%@ include file="../common/header.jspf"%>
    ...
    <div class="container">
        ...
        <c:if test="${anyError}">
            <div class="text-warning">Error!!! ${errorMessage}</div>
            <br/>
        </c:if>
        
    	<c:if test="${not empty products}">
	        <table class="table table-striped">
	            <caption>Inventory Products:</caption>
	            <thead>
	                <tr>
	                    <th>ProductId</th>
	                    <th>Category</th>
	            ...
	            <tbody>
	                <c:forEach items="${products}" var="product">
	                    <tr>
	                        ...
	                        <td>${product.price}</td>
	                        <!-- type="button"  -->
	                        <td><a class="btn btn-success" href="/onlinestore/update-inventory-product?productId=${product.productId}">Update</a></td>
							<!-- type="button"  -->
							<td><a class="btn btn-warning" href="/onlinestore/delete-inventory-product?productId=${product.productId}">Delete</a></td>
	                    </tr>
	                </c:forEach>
	            </tbody>
	        </table>
