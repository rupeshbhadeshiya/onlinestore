...
public class ProductCatalogExceptionHandler {
	...
	public @ResponseBody ErrorDetails onException(Exception ex) throws Exception {
		...
		System.err.println("============> Inside onException() of productcatalogExceptionHandler: ex = " + ex);
...
//	public @ResponseBody ErrorDetails onConstraintValidationException(ConstraintViolationException ex) {
	...
	public @ResponseBody ErrorDetails onTransactionSystemException(TransactionSystemException ex) {
		...
		System.err.println("============> Inside onTransactionSystemException() of productcatalogExceptionHandler: ex = " + ex);
...
//	    });
		...
		System.err.println("============> Inside onTransactionSystemException() of ProductCatalogExceptionHandler: cause = " + cause);
...
//		return error;
	...
	public @ResponseBody ErrorDetails onMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
		...
		System.err.println("============> Inside onMethodArgumentNotValidException() of ProductCatalogExceptionHandler: ex = " + ex);
