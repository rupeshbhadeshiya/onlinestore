...
//			PRODUCT_CATALOG_SERVICE_URL, requestDTO, AddItemResponseDTO.class
//		);
...
//			PRODUCT_CATALOG_SERVICE_URL, requestDTO, ErrorDetails.class
//		);
...
//	}
	...
	void retrieving_all_items() throws IOException {
		...
		GetProductsResponseDTO responseDTO = (GetProductsResponseDTO) HttpUtil.get(
			PRODUCT_CATALOG_SERVICE_URL, GetProductsResponseDTO.class
		);
...
//			PRODUCT_CATALOG_SERVICE_URL, GetItemsResponseDTO.class
//		);
//		
...
//			PRODUCT_CATALOG_SERVICE_URL + "/" + inventoryItem.getItemId(), InventoryItem.class
//		);
//		assertNotNull(item);
...
//			PRODUCT_CATALOG_SERVICE_URL + "/searches", requestDTO, SearchItemsResponseDTO.class
//		);
//		
//		assertNotNull(responseDTO);
...
//		
//		HttpUtil.delete(PRODUCT_CATALOG_SERVICE_URL + "/" + pencilItem.getItemId());
//		
//		assertNull( 
//			HttpUtil.get(
//				PRODUCT_CATALOG_SERVICE_URL + "/" + pencilItem.getItemId(), InventoryItem.class
//			)
//		);
//	}
//
...
//		
//		HttpUtil.delete(PRODUCT_CATALOG_SERVICE_URL, request1);
//		
...
//			PRODUCT_CATALOG_SEARCH_URL, request1DTO, SearchItemsResponseDTO.class
//		);
...
//		
//		HttpUtil.delete(PRODUCT_CATALOG_SERVICE_URL, request2);
//		
...
//			PRODUCT_CATALOG_SEARCH_URL, request2DTO, SearchItemsResponseDTO.class
//		);
...
//		
//		HttpUtil.delete(PRODUCT_CATALOG_SERVICE_URL, request3);
//		
...
//			PRODUCT_CATALOG_SEARCH_URL, request3DTO, SearchItemsResponseDTO.class
//		);
