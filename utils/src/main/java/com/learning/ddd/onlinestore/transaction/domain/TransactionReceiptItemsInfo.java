...
public class TransactionReceiptItemsInfo {

	private List<OrderItem> items;
	private int totalItems;
	private double totalAmount;
	
	public TransactionReceiptItemsInfo() {
	}

	public TransactionReceiptItemsInfo(List<OrderItem> items, int totalItems, double totalAmount) {
		super();
		this.items = items;
